...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        int itemWidth = a.getDimensionPixelOffset(R.styleable.WheelView_wheelItemWidth, $dp(R.dimen.dp_160));
        int itemHeight = a.getDimensionPixelOffset(R.styleable.WheelView_wheelItemHeight, $dp(R.dimen.dp_40));
        int textSize = a.getDimensionPixelSize(R.styleable.WheelView_wheelTextSize, $sp(R.dimen.sp_20));
        int textColor = a.getColor(R.styleable.WheelView_wheelTextColor, $color(R.color.wheel_text_color));
        int selectedTextSize = a.getDimensionPixelSize(R.styleable.WheelView_wheelSelectedTextSize, $sp(R.dimen.sp_20));
        ...
        mSelectedTextPaint.setTextSize(selectedTextSize);
        mSelectedTextPaint.setColor(selectedTextColor);

        mDividerPaint = new Paint();
        mDividerPaint.setAntiAlias(true);
        mDividerPaint.setStrokeWidth(getResources().getDimensionPixelOffset(R.dimen.dp_1));
